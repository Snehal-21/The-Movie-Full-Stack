...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <nav className='h-16 w-full bg-gray-950 flex justify-around fixed top-0 z-30'>
                ...
                <div className='w-[55%] ml-28 h-full flex justify-between items-center text-gray-600 text-lg '>
                    ...
                    {username ? <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" className='w-[100px] h-[60%] border border-gray-700 hover:bg-slate-600 hover:text-white rounded-lg cursor-pointer'>{username}</button> : <button onClick={handleRegister} className='w-[100px] h-[60%] border border-gray-700 hover:bg-slate-600 hover:text-white rounded-lg cursor-pointer'>Sign In</button>}
